...
import joe.com.steveapp.Model.Cart;
import joe.com.steveapp.Model.Products;
import joe.com.steveapp.Prevalent.Prevalent;
import joe.com.steveapp.ViewHolder.CartViewHolder;
...
public class CartActivity extends AppCompatActivity
{
    ...
    private int overTotalPrice = 0, oneTyprProductTPrice,count = 0;
    String name,price="70";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        txtTotalAmount.setText("Total Price = R " + String.valueOf(70));
    ...
    protected void onStart()
    {
        ...
        FirebaseRecyclerAdapter<Cart, CartViewHolder> adapter
...

            {
                ...
                model.setPname(name);
                model.setPid(Integer.toString(count + 1));
                ...
                overTotalPrice =Integer.parseInt(model.getPrice());
